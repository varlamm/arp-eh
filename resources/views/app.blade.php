...
<head>
    ...
    <link rel="icon" id="favicon-32" type="image/png" sizes="32x32" href="/favicons/favicon-32x32.png">
    <link rel="icon" id="favicon-16" type="image/png" sizes="16x16" href="/favicons/favicon-16x16.png">
    <link rel="manifest" href="/favicons/site.webmanifest">
    <link rel="mask-icon" href="/favicons/safari-pinned-tab.svg" color="#5851d8">
    <link rel="shortcut icon" id="favicon-icon" href="/favicons/favicon.ico">
